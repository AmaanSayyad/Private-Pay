...
import {
    Shield, Copy, ExternalLink, Wallet, BarChart3,
    CheckCircle, AlertCircle, Lock, Zap, Send
} from 'lucide-react';
...
export default function AleoPage() {
    const { publicKey, wallet, connected, signAndSendTransaction } = useWallet();
    ...
    const handleTransfer = async () => {
        ...
        try {
            ...
            console.log('[Aleo] Sending transaction:', transaction);

            const txId = await signAndSendTransaction(transaction);

            toast.success(`Transfer successful! TX: ${txId?.substring(0, 10)}...`);
            setRecipient('');
            setAmount('');
        } catch (error) {
                            ...
                            <CardBody className="p-6">
                                <div className="flex items-center justify-between mb-4">
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-xs text-gray-500">Aleo Testnet</p>
                                        </div>
                                    </div>
                                ...
                                <div className="space-y-3">
                                    <div className="flex justify-between items-center text-sm">
                                        ...
                                        <span className="text-gray-900 font-bold">#{blockHeight}</span>
                                    </div>
                                    <div className="flex justify-between items-center text-sm">
                                        <span className="text-gray-500">Network</span>
                                        <span className="text-gray-900 font-bold">TESTNET</span>
                                    </div>
                                    <div className="flex justify-between items-center text-sm">
                        ...
                        <Card className="bg-white border border-gray-200 shadow-md rounded-2xl">
                            <CardBody className="p-6">
                                <div className="flex items-center gap-3 mb-4">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-bold text-gray-900">Privacy Features</h3>
                                        <p className="text-xs text-gray-500">Zero-Knowledge Proofs</p>
                                    </div>
                                </div>
                                <div className="space-y-2">
                                    ...
                                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                                        <span className="text-sm text-gray-700">Programmable Privacy</span>
                                        <CheckCircle size={16} className="text-green-600" />
                                    </div>
                                    <div className="flex items-center justify-between p-3 bg-gray-50 rounded-xl">
                                        <span className="text-sm text-gray-700">Scalable ZK Proofs</span>
                                        <CheckCircle size={16} className="text-green-600" />
                                    </div>
                                </div>
                            </CardBody>
                    ...
                    <Card className="bg-white border border-gray-200 shadow-md rounded-2xl">
                        <CardBody className="p-6">
                            <div className="flex items-center gap-3 mb-4">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-gray-900">Private Transfer</h3>
                                    <p className="text-xs text-gray-500">Send credits privately</p>
                                </div>
                            </div>
                            ...
                            <div className="space-y-4">
                                <div>
                                    ...
                                    <input
                                        ...
                                        placeholder="aleo1..."
                                        className="w-full px-4 py-2.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent font-mono text-sm"
                                    />
                                </div>
                                ...
                                <Button
                                    ...
                                    className="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold h-11 rounded-xl"
                                ...
                                <p className="text-xs text-gray-500 text-center">
                                    Fee: 1 credit • Private transaction using zk-SNARKs
                                </p>
                            </div>
                        </CardBody>
                    </Card>
                            ...
                            <CardBody className="p-6 flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-blue-700 mt-1 leading-relaxed">
                                        You are connected to Aleo Testnet. Credits have no real value.
                                    </p>
                                    <Button
                                        size="sm"
                                        className="mt-3 bg-blue-600 text-white font-semibold rounded-xl"
                            ...
                            <CardBody className="p-6 flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p className="text-xs text-purple-700 mt-1 leading-relaxed">
                                        For transfers and advanced features, use the Leo Wallet extension.
                                    </p>
                                    <Button
                                        size="sm"
                                        className="mt-3 bg-purple-600 text-white font-semibold rounded-xl"
                                        endContent={<ExternalLink size={12} />}
                                        as="a"
                                        href="https://leo.app/"
                                        target="_blank"
